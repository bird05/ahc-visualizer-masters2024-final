...
export const TarTurnInput = () => {
  ...
  // Redux==============================
  const turnLim = useSelector((state) => state.output.b.V);
  ...
  return(
    <>
      <SLabel>turn:</SLabel>
      <InputTrunSelect type="number" id="turn" defaultValue={tarTurn} min={0} max={turnLim} onChange={(e) => dispatch(setTarTurn(e.target.value))}/>
    </>
  )
};